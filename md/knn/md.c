               ...
               int32_t NL[nAtoms * maxNeighbors], command_t cmd)
{
    ...
    static TYPE _force_x[nAtoms];
    static TYPE _force_y[nAtoms];
    static TYPE _force_z[nAtoms];
    static TYPE _position_x[nAtoms];
    static TYPE _position_y[nAtoms];
    static TYPE _position_z[nAtoms];
